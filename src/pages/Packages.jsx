...
const Packages = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Travel Packages - Holiday Destiny</title>
        <meta name="description" content="Explore our curated travel packages designed to give you the best experience." />
      </Helmet>

      {/* Hero Section */}
      <section 
      className="bg-cover bg-center text-white min-h-[45vh] flex items-center"
      // style={{ backgroundImage: `url(${packagesImage})` }}
      style={{ backgroundImage: `url(${'https://codewithsadee.github.io/tourly/assets/images/hero-banner.jpg'})` }}
    >
      <div className="container-custom text-center">
        <h1 className="text-4xl md:text-6xl font-bold font-display mb-6">
          Travel <span className="bg-gradient-to-r from-yellow-200 to-red-400 bg-clip-text text-transparent">Packages</span>
        </h1>
