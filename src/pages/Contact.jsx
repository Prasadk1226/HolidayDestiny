    ...
    >
      <div className="container-custom text-center">
        <h1 className="text-4xl md:text-6xl font-bold font-display mb-6">
          Get in <span className="bg-gradient-to-r from-yellow-200 to-red-400 bg-clip-text text-transparent">Touch</span>
        </h1>
                    ...
                    {submitStatus === 'success' ? (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm">Please try again or contact us directly at info@Holiday Destiny.com</p>
                        </div>
                      </div>
                    )}
                  </div>
