...
const Destinations = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Destinations - Holiday Destiny</title>
        <meta name="description" content="Explore our curated collection of amazing destinations around the world." />
      </Helmet>
    ...
    >
      <div className="container-custom text-center">
        <h1 className="text-4xl md:text-6xl font-bold font-display mb-6">
          Explore <span className="bg-gradient-to-r from-yellow-200 to-red-400 bg-clip-text text-transparent">Destinations</span>
        </h1>
