...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { path: '/destinations', label: 'Destinations', anchor: 'destinations' },
    { path: '/packages', label: 'Packages', anchor: 'packages' },
...
//                     : 'text-gray-900 hover:border-gray-900 border-transparent'
//                 }`}
//               >
//                 {item.label}
//               </button>
...
//           {/* CTA Button */}
//           <div className="hidden md:block">
//             <button className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-primary font-semibold py-2 px-6 rounded-lg border border-transparent transition-all duration-300 transform hover:scale-105 shadow-lg">
//               Book Now
//             </button>
//           </div>
...
//           <button
//             onClick={() => setIsOpen(!isOpen)}
//             className="md:hidden p-2 rounded-lg text-gray-900 hover:border-gray-900 border border-transparent transition-colors"
//           >
//             <svg
//               className="w-6 h-6"
//               fill="none"
...
//                   key={item.path}
//                   onClick={() => handleNavigation(item)}
//                   className={`w-full text-left font-medium transition-all duration-300 px-4 py-3 rounded-lg border ${
//                     location.pathname === item.path
//                       ? 'text-gray-900 border-gray-900'
//                       : 'text-gray-900 hover:border-gray-900 border-transparent'
//                   }`}
...
//               ))}
//               <div className="pt-4">
//                 <button className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-primary font-semibold py-3 px-6 rounded-lg border border-transparent transition-all duration-300">
//                   Book Now
//                 </button>
//               </div>
//             </div>
